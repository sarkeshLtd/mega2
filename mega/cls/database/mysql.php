...
#this function do quary with paameters for find parameters type see pdo_obj below
...
public function export_to_file(){
    $command='mysqldump --opt -h' . DB_HOST .' -u' . DB_USER .' -p' . DB_PASS .' ' . DB_NAME .' > ' . APP_PATH . 'upload/buffer/database.sql';
